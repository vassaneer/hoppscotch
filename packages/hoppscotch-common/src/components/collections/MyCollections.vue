...
// active tab's request. For a request at folderPath "0/1/2", the set is
// {"0", "0/1", "0/1/2"} — one entry per ancestor collection/folder.
const activeRequestPathPrefixes = computed(() => {
  ...
  const segments = saveCtx.folderPath.split("/")
